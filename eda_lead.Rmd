...
I have seperated anyone with incomes or energy costs less than or equal to $0 into another dataset for analysis. This represents approximately `r round(100*n_or_zero_unit_rate,0)`% of the housing units and `r round(100*n_or_zero_rate,0)`% of the examined cohorts, so it will be important to make sure that this subset does not contain systematic bias.
